...
import com.verizon.ssp.roctool.helper.AssignmentDaemonHelper;
import com.verizon.ssp.roctool.timer.TimeImpl;

public class AssignmentDaemon extends TimerTask {
	...
	public static synchronized void startDaemon() {
		...
		if (timer == null) {
			...
			timer = new Timer();
			AssignmentDaemon task = new AssignmentDaemon();
	...
	public void run() {
		...
		AssignmentDaemonHelper.getROCTicketsFromRocDB();
	}
}
