...
public class FTPTimeImpl implements iTime {
	...
	public void getStartTime() {
		...
		startTimeHour = Utils.getPropertyValue(prop, "FTP_START_TIME_HOUR");
		startTimeMin = Utils.getPropertyValue(prop, "FTP_START_TIME_MIN");
		howOften = Utils.getPropertyValue(prop, "FTP_WAKE_UP_INTERVAL");
	}
	
	@Override
	public void seeStartTime() {
		getStartTime();
		logger.debug("Starting Daemon at: " + startTimeHour + ":" + startTimeMin + ", running it every " + howOften + " mins");
	}	
